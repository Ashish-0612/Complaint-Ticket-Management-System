  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <nav className="bg-white shadow-md p-4 flex justify-between items-center">
        <h1 className="text-xl font-bold text-green-600">CTMS Agent</h1>
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-md text-center">
            ...
            <p className="text-gray-500 mt-1">Assigned Tickets</p>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          {!loading && tickets.length === 0 && (
            <div className="text-center py-10">
              <p className="text-gray-500 text-lg">No tickets assigned yet!</p>
              <p className="text-gray-400 text-sm mt-2">
                Admin will assign tickets to you soon.
              </p>
            </div>
          )}
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="ml-4 text-right">
                      ...
                      <select
                        ...
                        className="border p-2 rounded text-sm outline-none focus:border-green-500"
                      >
